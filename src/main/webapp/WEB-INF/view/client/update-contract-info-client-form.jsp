...
<form:form action="/common/saveContract" modelAttribute="model">
    ...
    <form:hidden path="contract.contractClient.phone_number"/>
    <form:hidden path="contract.contractClient.first_name"/>
    <form:hidden path="contract.contractClient.surname"/>
    <form:hidden path="contract.contractClient.email_address"/>
